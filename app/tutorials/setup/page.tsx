  ...
  piano: [
    {
      ...
      description: "Make a fist gesture and position your hand at different horizontal positions to play different notes. Try to play a C note (leftmost position).",
      gesture: "Closed_Fist",
    ...
    },
    {
      ...
      description: "Make a fist gesture and move your hand up and down to control the volume. Try to play a loud note by positioning your hand at the top of the screen.",
      gesture: "Closed_Fist",
      targetPosition: { x: 0.5, y: 0.2 },
      tolerance: 0.2,
      image: "/tutorials/piano-gesture-2.jpg",
      tip: "The vertical position of your hand controls the volume - higher position means louder sound."
    },
    {
      id: "piano-3",
      title: "Playing a Chord",
      description: "Make an open palm gesture to play a chord. Try to play a C major chord.",
      gesture: "Open_Palm",
      targetPosition: { x: 0.1, y: 0.5 },
      tolerance: 0.2,
  ...
  guitar: [
    {
      ...
      description: "Make a fist gesture and position your hand at different vertical positions to select different strings. Try to play the lowest string (bottom position).",
      gesture: "Closed_Fist",
    ...
    },
    {
      ...
      description: "Make a fist gesture and position your hand at different horizontal positions to change the fret position. Try to play the 3rd fret.",
      gesture: "Closed_Fist",
    ...
    },
    {
      ...
      description: "Make an open palm gesture and move your hand from top to bottom to strum all strings.",
      gesture: "Open_Palm",
  ...
  theremin: [
    {
      ...
      description: "Make an open palm gesture and move your hand left and right to change the pitch. Try to produce a low pitch sound (left side).",
      gesture: "Open_Palm",
      targetPosition: { x: 0.1, y: 0.5 },
      tolerance: 0.2,
    ...
    },
    {
      id: "theremin-2",
      title: "Controlling Volume",
      description: "Keep your palm open and move your hand up and down to control volume. Try to play a soft sound (bottom position).",
      gesture: "Open_Palm",
    ...
    },
    {
      ...
      description: "Make an open palm gesture and slightly vibrate your hand horizontally to create a vibrato effect.",
      gesture: "Open_Palm",
      targetPosition: { x: 0.5, y: 0.5 },
      tolerance: 0.5,
...
export default function InstrumentTutorialPage() {
  ...
  // Restart all audio when changing instruments
  useEffect(() => {
  ...
  useEffect(() => {
    ...
    async function processFrame() {
      if (videoEl.readyState >= videoEl.HAVE_ENOUGH_DATA) {
          ...
          if (results?.gestures && results.gestures.length > 0) {
            ...
            if (firstHandGestures && firstHandGestures.length > 0) {
              ...
              if (results.landmarks && results.landmarks.length > 0) {
                ...
                // Check if current gesture and position match the tutorial step
                checkStepCompletion(topGesture.categoryName, position);
                
                // Play appropriate sound for the gesture
        ...
        // Draw target position indicator for the current step
  ...
  // Function to play appropriate sound for the recognized gesture
  const playSoundForGesture = useCallback((gesture: string, position: { x: number, y: number }) => {
    const audioCtx = audioContextRef.current;
    ...
    // Calculate note based on position and instrument
    let noteIndex = 0;
    let volume = 0.5;
    ...
    if (selectedInstrument === "piano") {
      ...
      // Theremin uses continuous pitch
  ...
  // Check if current step is completed based on gesture and position
  const checkStepCompletion = useCallback((gesture: string, position: { x: number, y: number }) => {
      ...
      if (xDiff <= currentStep.tolerance && yDiff <= currentStep.tolerance) {
        ...
        setTimeout(() => {
          ...
          if (currentStepIndex < currentSteps.length - 1) {
            ...
            // Check if all steps for all instruments are completed
    ...
    <div className="min-h-screen bg-gradient-to-b from-teal-50 to-white">
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {/* Left panel: Instructions & Tutorial Progress */}
          ...
          {/* Right panel: Webcam Feed and Instrument Visualization */}
              ...
              <CardContent className="p-0 relative">
                ...
                {!webcamEnabled ? (
                  ...
                  <div className="relative aspect-video">
                    ...
                    {/* Instrument visualization overlay */}
              ...
              <div className="bg-gray-900 h-64 relative">
                ...
                {selectedInstrument === "theremin" && (
                  <ThreeThereminVisualizer 
                    pitchPosition={handPosition?.x ?? 0.5} 
                    volumePosition={handPosition?.y ?? 0.5} 
                  />
                )}
