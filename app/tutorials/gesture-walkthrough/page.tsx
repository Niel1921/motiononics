...
export default function GestureWalkthroughWithMediapipe() {
    ...
    async function processFrame() {
      if (videoEl.readyState >= videoEl.HAVE_ENOUGH_DATA) {
        ...
        try {
          ...
          // If not custom, use Mediapipe gesture name
          if (!customGesture) {
  ...
  useEffect(() => {
    ...
    // If the correct gesture has been held for 3 seconds, move to the next gesture adn play sound/animation
    if (heldTime === 3) {
